...
/**
 * This sample code was taken and modified from the Accumulo examples...
 * 
...
public class Index {
  ...
  public static void indexContents(int numPartitions, Text docId, String doc, String splitRegex, BatchWriter bw) throws Exception {
  ...
  public static void index(int numPartitions, File src, String splitRegex, BatchWriter bw) throws Exception {
    if (src.isDirectory()) {
      ...
      indexContents(numPartitions, new Text(src.getAbsolutePath()), sb.toString(), splitRegex, bw);
    }
  }
